...
<Project Type="Project" LVVersion="17008000">
	...
	<Property Name="varPersistentID:{0B793E71-E7F2-40EE-A0E5-C2E8986E91FB}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-T0</Property>
	<Property Name="varPersistentID:{0E2B141C-1BBC-460F-BD03-738F583AF760}" Type="Ref">/My Computer/Shared Variables.lvlib/SIS-10SDV502</Property>
	<Property Name="varPersistentID:{1144F699-833A-473E-BDEE-CC8FD1B5D252}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10HIC100</Property>
	<Property Name="varPersistentID:{183DF50C-79C6-45CB-94BE-406A8245611F}" Type="Ref">/BPCS-NI-cRIO-9064-01c4fb12/BPCS Variables.lvlib/BPCS-SIM-TX-ARRAY</Property>
	<Property Name="varPersistentID:{1BC44DF4-E379-410C-A135-894DF748AB62}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-CA0</Property>
	<Property Name="varPersistentID:{334E05B8-4A2E-4107-A3BA-43C9CE02F1AE}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10AIC300-SP</Property>
	<Property Name="varPersistentID:{33A8FFAD-CD03-4E58-A9CC-E5FC5BAAE058}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-FJ</Property>
	<Property Name="varPersistentID:{3AB8FAF2-3CFA-42A2-B205-A7FDFE88685E}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10LIC200_MA</Property>
	<Property Name="varPersistentID:{3F8B328F-1A3F-4BC4-8236-7EC9047E8A95}" Type="Ref">/SIS-NI-cRIO-9063-01c525ec/SIS Variables.lvlib/SIS-SIM-TX-ARRAY</Property>
	<Property Name="varPersistentID:{432577D5-54FA-48F2-B297-07167C422F96}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10TIC100_MA</Property>
	...
	<Property Name="varPersistentID:{7F76FF45-5404-47B5-B8FA-CC7D25C5A305}" Type="Ref">/BPCS-NI-cRIO-9064-01c4fb12/BPCS Variables.lvlib/SIM-BPCS-RX-ARRAY</Property>
	<Property Name="varPersistentID:{8F9AF14D-7B6F-4F84-96EF-6118F7EDC62A}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10TIC100-SP</Property>
	<Property Name="varPersistentID:{959CDDAB-2E6D-432D-982A-606B6183CFAB}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-10LY200</Property>
	...
	<Property Name="varPersistentID:{A7B84D50-043C-4AEF-B8B7-A288CB787F0E}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-F</Property>
	<Property Name="varPersistentID:{BC163D4A-0E3E-440A-81C4-AF8DC4B9B363}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10AIC300_MA</Property>
	<Property Name="varPersistentID:{BCAC2DAD-7B9E-45A4-8CA6-E88B2E14CBFD}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-F0</Property>
	<Property Name="varPersistentID:{C8C60E17-D103-4E39-A253-4A215987B023}" Type="Ref">/My Computer/Shared Variables.lvlib/SIS-10LI202</Property>
	<Property Name="varPersistentID:{D1CD5DEA-4611-4925-8988-D2E1AF4B1703}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10HIC200</Property>
	<Property Name="varPersistentID:{DFC3DF4D-820B-4497-A4A3-719C599D6086}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10LIC200-KPID</Property>
	<Property Name="varPersistentID:{E48F3834-7C26-4879-9E82-729355010087}" Type="Ref">/My Computer/Shared Variables.lvlib/BPCS-10TI100</Property>
	<Property Name="varPersistentID:{E4BA738E-3BBE-4DCB-ACF8-B9FA5BF6B96D}" Type="Ref">/My Computer/Shared Variables.lvlib/HMI-10HIC300</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="SIS Variables.lvlib" Type="Library" URL="../SIS Variables.lvlib"/>
